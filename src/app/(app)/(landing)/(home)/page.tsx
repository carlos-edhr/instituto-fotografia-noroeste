...
export default async function HomePage() {
  ...
  if (!page) {
    ...
    /* ORIGINAL STATIC LANDING PAGE *FOR PRODUCTION*  */
    // <>
    //   <Hero />
    ...
    // </>
    {
      /* END ORIGINAL STATIC LANDING PAGE */
    }
        ...
        <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
          <div className="text-center max-w-2xl mx-auto px-6">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Crea la página de inicio desde el panel de administración de
              Payload CMS.
            </p>
            <div className="space-y-4">
              <p className="text-gray-500">
                Ve a{" "}
                <code className="bg-gray-100 px-2 py-1 rounded">/admin</code> y
                crea una página con slug landing-page para comenzar.
              </p>
            </div>
          </div>
        </main>
