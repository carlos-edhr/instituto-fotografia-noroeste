...
import type { CursoTresBlock as CursoTresBlockType } from "@/types/blocks";

export const CursoTresBlockComponent: React.FC<CursoTresBlockType> = (
  props,
) => {
  const {
    header,
          ...
          <div className="mb-8">
            <div className="flex flex-col items-center justify-center">
              ...
              <h2 className="text-xl md:text-3xl font-extralight text-red-500 uppercase">
                {header?.subtitle || "FOTOGRAFÍA PROFESIONAL"}
              </h2>
            </div>
          </div>
            ...
            <Card className="bg-black/70 backdrop-blur-sm border border-red-500/30 rounded-xl p-6">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-3">
                  {instructor?.name || "Mtro. Caneck Leyva"}
                </p>
                <Link
                  href={instructor?.link || "https://www.caneckleyva.com"}
                  target="_blank"
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      {courseInfo?.startDate || "18 DE OCTUBRE 2025"}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      {courseInfo?.schedule || "SÁBADOS | 10:00 AM - 2:00 PM"}
                    </p>
                  </div>
                </div>
                <div className="pt-3 border-t border-red-900/30">
                  <p className="text-gray-400 text-sm">
                    ...
                    {courseInfo?.duration || "3 semanas"}
                    <br />
                    <strong>Cierre:</strong>{" "}
                    {courseInfo?.endDate || "1 de Noviembre"}
                  </p>
                </div>
              </div>
            </Card>
              ...
              <Tabs defaultValue="temario" className="w-full">
                ...
                <TabsContent value="temario" className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      {syllabus?.slice(3, 6).map((item, index) => (
                        <div
                          key={index + 3}
                          className="flex items-start gap-4 p-4 bg-black/50 rounded-lg border border-red-900/30 group hover:border-red-500/40 transition-all"
                        >
                  ...
                  <div className="bg-black/50 rounded-lg border border-red-900/30 p-6 mt-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 text-gray-300 text-sm">
                      ...
                      <ul className="space-y-2">
                        {learningPoints?.slice(3, 6).map((point, index) => (
                          <li
                            key={index + 3}
              ...
              <div className="p-6 pb-4">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">
                      {location?.venue || "Observatorio"} | Antiguo Cine Bujazan
                    </p>
                  </div>
                </div>
              </div>
