...
import { CursosPrivadosBlockType } from "../../types/blocks";
...
const CursosPrivadosComponent: React.FC<CursosPrivadosBlockType> = (props) => {
  const {
    headerBadge,
    headerTitle,
    headerSubtitle,
    ...
    virtualPricing,
    asesoriasTitle,
    asesoriasDescription,
    asesoriaPresencialTitle,
    asesoriaPresencialPrice,
    asesoriaPresencialDescription,
    asesoriaVirtualTitle,
    asesoriaVirtualPrice,
    asesoriaVirtualDescription,
    contactTitle,
    contactDescription,
    email,
    phone,
            ...
            <Tabs defaultValue="presencial" className="w-full">
              ...
              <TabsContent value="presencial" className="space-y-6">
                ...
                <div className="grid gap-6">
                  {presencialPricing?.map((item, index) => (
                    <motion.div
                      key={index}
              ...
              <TabsContent value="virtual" className="space-y-6">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-sm">{virtualDescription}</p>
                </div>
        ...
        >
          <Card className="bg-black/70 backdrop-blur-sm border-2 border-red-500/50 rounded-xl p-8">
            ...
            <div className="mt-8 pt-6 border-t border-red-900/50">
              <p className="text-gray-400 text-sm text-center">{footerNote}</p>
            </div>
          </Card>
        </motion.div>
      </div>
...
export default CursosPrivadosComponent;
